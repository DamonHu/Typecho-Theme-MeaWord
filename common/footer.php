<footer class="footer">
    <div class="container">
        ...
        <p>©️ <?php echo $this->options->startYear?$this->options->startYear.' - ':''; ?> <?php echo  date("Y")?> <?php $this->options->title(); ?>. Designed by <a href="https://github.com/Meayair/Typecho-Theme-MeaWord" target="_blank">MeaWord</a>
        </p>
...
<div class="offcanvas offcanvas-end" id="right-canvas" style="width: 80%;">
    <div class="sidebar_canvas">
        ...
        <!-- <div class="sidebar_box" style="height: calc(100vh - 127px);"> -->
            ...
            <aside id="nav_menu-2" class="widget widget_nav_menu">
                <h3 class="widget-title"><?php _e('独立页面'); ?></h3>
...
<script type="text/javascript" src="<?php $this->options->themeUrl('assets/js/main.js?ver=2.0.1.2'); ?>" id="main-js"></script>
<script>
