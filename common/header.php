...
<link rel='stylesheet' id='stylecss-css' href='<?php $this->options->themeUrl('assets/css/style.css?ver=2.0.1.14'); ?>' type='text/css' media='all' />
...
<?php while($categorys->next()): ?>
    <?php if ($categorys->levels === 0): ?>
        <li id="menu-item-<?php $categorys->mid(); ?>" class="menu-item menu-item-type-taxonomy menu-item-object-category <?php if($this->is('category', $categorys->slug)): ?> current-menu-item<?php endif; ?> menu-item-<?php $categorys->mid(); ?>">
